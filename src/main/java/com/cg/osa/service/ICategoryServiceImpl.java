...
public class ICategoryServiceImpl implements ICategoryService{
	...
	@Override
	public CategoryDTO updateCategory(@RequestBody CategoryDTO category)throws CategoryException {
	...
	@Override
	public CategoryDTO removeCategory(@PathVariable String id) throws CategoryException {
